...
import com.my_motors.halamotor.view.adapters.AdapterFollowing;
...
public class FollowingActivity extends AppCompatActivity {
    ...
    ArrayList<com.my_motors.halamotor.model.Following> followersArrayList = new ArrayList<>();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()) {
                            com.my_motors.halamotor.model.Following following = dataSnapshot1.getValue(com.my_motors.halamotor.model.Following.class);

...
import com.my_motors.halamotor.view.adapters.adapterInsurance.AdapterCarProcess;

import java.util.ArrayList;

import static com.my_motors.halamotor.dataBase.ReadFunction.getAllCarProcess;
import static com.my_motors.halamotor.functions.InsuranceFunctions.createCarInfoTable;
import static com.my_motors.halamotor.functions.InsuranceFunctions.getCarProcess;
import static com.my_motors.halamotor.functions.InsuranceFunctions.nextCarFragment;
import static com.my_motors.halamotor.functions.InsuranceFunctions.numberOfCarProcessSelected;
import static com.my_motors.halamotor.functions.InsuranceFunctions.resetAllCarInfoTable;
...
public class CarDetailsInsurance extends Fragment implements AdapterCarProcess.PassProcess{
    ...
    ArrayList<com.my_motors.halamotor.model.CarInformation> carAllProcessArrayL = new ArrayList<com.my_motors.halamotor.model.CarInformation>();
...
//        Log.i("TAG","Number: "+String.valueOf(checkIfCarDetailsProcessCreated(getActivity())));
    ...
    private void moveToCompleteInsuranceInfo() {
        ...
        if (numberOfCompletedProcess!=10)
        {
            ...
            com.my_motors.halamotor.view.fragments.insuranceFargment.CarDetailsInsurance.this.startActivityForResult(intent , REQUEST_DETAILS);
